...
class NickolayKehaiovController extends AbstractActionController
{
    ...
    public function addAction()
    {
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) { // if it is valid hets populated
                ...
                return $this->redirect()->toRoute('fmi/default', array('controller' => 'NickolayKehaiov', 'action'=> 'index' ));
            }
        }
    ...
    public function deleteAction()
    {
        ...
        if ($request->isPost()) {
            ...
            // Redirect to list of albums
                return $this->redirect()->toRoute('fmi/default', array('controller' => 'nickolay-kehaiov', 'action'=> 'index' ));
        }
