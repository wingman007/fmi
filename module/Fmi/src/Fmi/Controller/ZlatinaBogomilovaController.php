...
class ZlatinaBogomilovaController extends AbstractActionController
{
    ...
    public function addAction()
    {
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) { // if it is valid hets populated
                ...
                return $this->redirect()->toRoute('fmi/default', array('controller' => 'zlatina-bogomilova', 'action' => 'index'));
            }
        }
