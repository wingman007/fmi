...
//				$this->getUsersTable()->insert($data);
	...
	public function updateAction()
	{
		...
		if (!$id) return $this->redirect()->toRoute('csn_user/default', array('controller' => 'user-doctrine', 'action' => 'index'));
...
//				$this->getUsersTable()->update($data, array('usr_id' => $id));
	...
	public function deleteAction()
	{
        ...
        try {
			...
			$this->redirect()->toRoute('csn_user/default', array('controller' => 'user-doctrine', 'action' => 'index'));	
        }
